...
const TripStepThree = ({navigation}) => {
    ...
    return (
        <View style={{flex: 1, backgroundColor: "#fff", padding: 20, justifyContent: "space-between"}}>
            <View>
                <Text style={{fontSize: 23, color: "#4F4F4F", textAlign: "center", fontWeight: "bold"}}>Step 3 of
                    5</Text>

                <Text style={{fontSize: 20, color: "#3A3A3A", marginTop: 20, fontWeight: "bold"}}>Select Starting
                    Point</Text>
            ...
            <View style={{flexDirection: "row", justifyContent: "space-between"}}>
                <Button onPress={e => navigation.replace("TripStepTwo")}
                ...
                <Button onPress={e => navigation.replace("TripStepFour")}
